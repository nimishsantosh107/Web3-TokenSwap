...
// ERC223 token with added ERC20 and Ethereum-Token support
//
...
contract ERC223
{
    ...
    // Ethereum Token
    function mintTo( address to, uint256 value ) public returns (bool success) {
        balances_[to] += value;
        totalSupply += value;
    ...
    function transferToContract( address to,
                       uint value,
                       bytes calldata data,
